...
async def menu_command(message: Message):
    ...
    await message.answer(
        text=f"Підписуйтеся на наш <a href='{head_link}'>🎰 канал</a> щоб нічого не пропустити та переходьте за посиланням:\n\n"
             f"<b>Щоб переглянути наші <a href='{channel_link}'>🎰 Акції та знижки</a></b>",
        parse_mode="HTML",
